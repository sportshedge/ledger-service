...
CLIENT_BIN = ${CLIENT_DIR}
 ...
 export DB_PORT=5432
 export DB_NAME=golang_ledger
 export DB_TABLE_PREFIX=golang_ledger_
 export DB_SSL_MODE=disable
 export APP_PORT=3000
 export JWT_SECRET=usx1957-213123123123-12312sa7687-23424
...
test:
	go test ./... ## Launch tests

clean: clean_golang_ledger ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_golang_ledger: ## Clean generated files for grpc
	${RM_F_CMD} ${PROTO_DIR}/code/go/*.pb.go

rebuild: clean ledger ## Rebuild the whole project
